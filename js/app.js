...
var showHide = function(event) {
  var tabs = event.target.dataset.selecttab;
...
console.log(logroMetas('LIM', '2017-1', '0'));
...
console.log(logroMetasTech('AQP', '2016-2', '0'));
...
console.log(logroMetasLife('AQP', '2016-2', '0'));
