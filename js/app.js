...
sprintArrayCDMX20171 = [];
for (var i = 0; i < studentsCDMX20171.length; i++) {
  if (studentsCDMX20171[i].sprints) { // active = false
    sprintArrayCDMX20171.push(studentsCDMX20171[i]);
    console.log(sprintArrayCDMX20171);
  }
  for (var j = 0; j < sprintArrayCDMX20171.length; j++) {
    sprintArrayCDMX20171[i][j].sprints ;
  }
}
