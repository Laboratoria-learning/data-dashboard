window.addEventListener('load', function(event) {
  ...
  var optgroupt =document.getElementById('optgroupt');//primero
  var enrollment = document.getElementById('enrollment');
  var generation = document.getElementById('generation');//segundo
...
//Como ya estoy en la sede Lima, ya no necesito escoger la sede si quiero elegir otra generación; es por esta razón que se generó un nuevo evento  en "generation". OBSERVACIÓN: este evento también fue generado dentro del evento de elección de la sede
  ...
  for(var opLim in arrayLim){//con c/iteración y valiéndome del método split (que elimina el separador ('|') ) obtengo un nuevo array. Ejem :["2016-2", "2016-2"]. Esto se repetirá 3 veces en el caso de Lima.
